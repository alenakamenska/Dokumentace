...
Více se dozvíte v kapitole [Jak přidat podnik](navody.md#pridat-podnik)

## Správa podniku

Tato stránka slouží jako ovládací centrum pro váš podnik. Najdete zde tři hlavní sekce, které vám umožňují udržovat informace o podniku a sortimentu aktuální.

![Správa podniku](images/sprava-podniku.png)
...
* **Nový sortiment:** Zde vložíte název rostliny či zboží, popis, cenu a fotografii. Můžete ho také zařadit do kategorie a pokud se do žádné z nich nehodí můžete vytvořit novou přes tlačítko "Nová kategorie"

![Formulář pro přidání produktu](images/produkty-form.png)
...
![Správa produktů](images/sprava-produkty.png)
