...
Tato webová aplikace slouží jako digitální platforma propojující lokální zahradníky se zákazníky. Jejím hlavním cílem je usnadnit vyhledávání rostlin a zrahradního sortimentu ve vašem okolí a podpořit sdílení odborných rad v komunitě.
...
* **Zahradník:** Uživatel (obvykle majitel firmy nebo odborník), který kromě prohlížení obsahu může aktivně tvořit data. Má přístup ke správě vlastních podniků a produktů.
...
#### Ikony v pravé části:
* **Ikona šipky s obdélníkem:** Slouží k rychlému přihlášení do aplikace
* **Ikona postavy:** Slouží pro registraci, po přihlášení pro správu profilu

## Registrace {: #registrace }
* Aplikace umožňuje 2 způsoby registrace 

### Registrační formulář
![Registrační formulář](images/registrace.png)

1. **E-mailová adresa:** Zadejte svůj funkční e-mail, který bude sloužit jako vaše přihlašovací jméno
2. **Heslo:** Zvolte si bezpečné heslo a pro kontrolu jej napište podruhé do pole **Heslo znovu**. Tím předejdete překlepu
3. **Výběr role:** Toto je nejdůležitější krok:
    * **Zákazník:** Vyberte, pokud si chcete prohlížet podniky a sortiment
    * **Zahradník:** Vyberte, pokud chcete nabízet své produkty, psát rady nebo prezentovat svou práci
...
![Přihlášení přes Google](images/google-login.png)
...
* **Výběr role:** Pokud se přes Google přihlašujete poprvé (registrujete se), systém vás po přihlášení vyzve k výběru vaší role (**Zákazník** nebo **Zahradník**), aby věděl, jaké funkce vám má zpřístupnit

## Přihlášení {: #prihlaseni }

Po úspěšné registraci se můžete do aplikace kdykoliv vrátit a přihlásit se ke svému účtu.

![Obrazovka přihlášení](images/login.png)
